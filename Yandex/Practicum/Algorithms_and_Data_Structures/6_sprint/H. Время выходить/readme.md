...
Python 3.12.3             2.5 секунд            128Mb
...
В первой строке дано число вершин n (1 ≤ n ≤ 2⋅10^5) и рёбер m (0 ≤ m ≤ 2⋅10^5).
...
Выведите n строк, в каждой из которых записана пара чисел tin\_i, tout\_i — время входа и выхода для вершины i.
